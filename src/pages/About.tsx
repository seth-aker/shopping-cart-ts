    ...
    return (
        ...
        <Container className="d-flex flex-direction-column justify-content-center">
            <Card className="d-flex flex-direction-column h-100 w-100 p-3" style={{maxWidth: "800px"}} border="primary">
                <Image src="/Seth_headshot.jpg" roundedCircle height="50%" width="50%" className="align-self-center" />
                <CardBody >
                    ...
                    <Card.Text className="mt-1">I am a former music educator turned software developer. I am passionate about software development and I use my creativity, analytical thinking, and problem-solving skills that I honed as a teacher to make high-quality software. </Card.Text>
